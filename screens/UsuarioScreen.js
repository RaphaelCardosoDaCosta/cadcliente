...
export default function UsuarioScreen({ navigation }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: 20, backgroundColor: '#1e1543' }}>
        <Text style={{ marginBottom: 20, fontSize: 20, color: '#bfd2f9'}}>Bem-vindo!</Text>
